package com.evanstrange.collegeofthesouthpacific.news;
...
import com.evanstrange.collegeofthesouthpacific.R;
...
public class LazyNewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        newsDescription.setText(newsItem.getNewsDescription());
